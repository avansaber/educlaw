...
ROOT_DIR = os.path.dirname(MODULE_DIR)             # educlaw-k12/
...
def run_init_db(db_path: str):
    spec = importlib.util.spec_from_file_location("init_db_k12", VERTICAL_INIT_PATH)
    ...
    conn.execute(
        """INSERT INTO educlaw_student
           ...
           VALUES (?, ?, 'Test', 'Student', 'Test Student',
                   '2012-05-15', 'test@school.edu', 'active', ?, '')""",
