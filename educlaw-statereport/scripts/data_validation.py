...
def seed_validation_rules(conn, args):
    ...
    SEED_RULES = [
        ...
        ("SPED-007", "sped", "critical", "MDR Required for IDEA Suspension",
         ...
         "[]", "[]", 1,
         "SELECT student_id FROM educlaw_k12_discipline_action WHERE mdr_required=1 AND (mdr_outcome='' OR mdr_outcome='pending')",
        ...
        ("DISC-001", "discipline", "major", "Incident Has Students",
         ...
         "[]", "[]", 1,
         "SELECT id as incident_id FROM educlaw_k12_discipline_incident WHERE student_count_involved=0",
        ...
        ("DISC-002", "discipline", "critical", "MDR for IDEA Student 10+ Days",
         ...
         "[]", "[]", 1,
         "SELECT student_id FROM educlaw_k12_discipline_action WHERE mdr_required=1 AND mdr_outcome NOT IN ('manifestation','not_manifestation')",
        ...
        ("DISC-003", "discipline", "major", "Incident Date Required",
         ...
         "[]", "[]", 1,
         "SELECT id as incident_id FROM educlaw_k12_discipline_incident WHERE incident_date=''",
        ...
        ("DISC-004", "discipline", "major", "Incident Type Required",
         ...
         "[]", "[]", 1,
         "SELECT id as incident_id FROM educlaw_k12_discipline_incident WHERE incident_type=''",
        ...
        ("DISC-005", "discipline", "minor", "Action Dates Required",
         ...
         "[]", "[]", 0,
         "SELECT id as action_id FROM educlaw_k12_discipline_action WHERE start_date='' AND action_type!='no_action'",
        ...
        ("DISC-006", "discipline", "major", "Days Removed Non-Negative",
         ...
         "[]", "[]", 1,
         "SELECT id as action_id FROM educlaw_k12_discipline_action WHERE days_removed < 0",
